 ...
 function keenshot_footer_section(){
   ...
   <section class="footer">
    ...
    <?php } else { 
        ...
        // not to break the existing users site footer 
    ...
    <section class="footer">
        <div class="container">
            <div class="footer-wrapper">
                ...
                <div class="quick-contact old_widget">
                    <div class="widget" id="copywrite">
                ...
                <div class="copy-right-area text-center old_widget" id="address">
                <?php if(get_theme_mod( 'sample_default_footer_text_body', '' )): ?>
                    <div id="keenshot_copyright_widget-4" class="widget">
                ...
                <div class="instagram-photos old_widget">
                    <div class="widgets">
...
function keenshot_content_after_body_section(){
    ...
    <header class="header">
        <nav class="navbar">
            <div class="container">
                <div class="navigation <?php echo get_theme_mod('header_layout', 'left_right'); ?>">
        ...
        <div class="row">
            <div class="col-md-12">
                <h1><?php echo esc_html(apply_filters( 'keenshot_blog_title', __('Blog', 'keenshot') ),'keenshot'); ?></h1>
                 <h5><?php echo esc_html(apply_filters( 'keenshot_blog_subtitle', get_bloginfo('description') ),'keenshot'); ?></h5>
            </div>
        </div>
    </div>
